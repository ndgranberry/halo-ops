...
class ScoutConfig:
    ...
    solve_plan_model: str = field(default_factory=lambda: os.getenv("SCOUT_PLANNER_MODEL", "claude-sonnet-4-6"))
    ...
    # Scoring settings
    score_model: str = field(default_factory=lambda: os.getenv("SCOUT_SCORE_MODEL", "claude-sonnet-4-6"))
